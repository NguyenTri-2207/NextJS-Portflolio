...
import data1 from "components/templates/HomeTemplate/data.json";
  ...
  return (
    <div className="timeline">
      <div className="bg-[#fff4f4] dark:bg-gray-600 py-4 pl-5 pr-3 space-y-2 mb-6 rounded-lg dark:border-[#212425] dark:border-2">
        ...
        <p className="dark:text-[#b7b7b7] mb-2 text-sm line-clamp-3">{description}</p>
        ...
        <div className="about-text lg:col-8 col-12 lg:-mt-4 ">
          ...
          <div className=" pb-7 border-b border-gray-700 dark:border-gray-50 dark:text-gray-300 text-sm">
            <p className="mb-3 leading-7 ">
              I'm a Software Engineer with 3+ years of experience React and state management like Redux with proficiency in web technologies like HTML5, CSS3, JavaScript, building large-scale web applications, cross-browser platforms, and design constraints on the web, and building responsive user interfaces.
            </p>
            <ul>
              <li className=" mb-2">✨ Version control system (GIT), Defect Tracking tool (Jira,Clickup), design platform (Figma), and testing framework such as Jet.
              </li>
              <li className=" mb-2">            ✨ Languages: React, Typescript, JavaScript, NodeJS.
              </li>
              ...
              <li className=" mb-2">✨Other Tools: Performance Optimization Tools, Cross-Browser Testing: BrowserStack, Web Hosting Platforms: Vercel, AWS, Content Management Systems (CMS):WordPress.</li>
            </ul>
          </div>
